        ...
        <div className="relative z-[var(--z-content)]">
          ...
          >
            ...
            <span className="block text-background dark:text-foreground text-[clamp(48px,13.8vw,374px)] -mt-[0.05em] ml-[0.10em] relative z-10">
              <span aria-hidden="true" data-anim="hero-slashes" className="inline-block text-[var(--sf-dim-text)] text-[clamp(32px,9.1vw,250px)]">{"//"}</span><span className="inline-block overflow-hidden border-l-[3px] border-solid border-background dark:border-foreground box-border"><span suppressHydrationWarning aria-hidden="true" data-anim="hero-char" className="inline-block pl-[0.04em]">U</span></span><span className="inline-block overflow-hidden"><span suppressHydrationWarning aria-hidden="true" data-anim="hero-char" className="inline-block">X</span></span>
            </span>
          </h1>
        </div>
