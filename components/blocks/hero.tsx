  ...
  return (
    <section className="mt-[var(--nav-height)] grid grid-cols-1 md:grid-cols-2 h-[calc(var(--sf-canvas-h)-var(--nav-height,0px))] border-b-4 border-foreground overflow-hidden">
      ...
      <div className="bg-foreground dark:bg-[var(--sfx-darker-surface)] text-background dark:text-foreground pr-[clamp(16px,calc(4*var(--sf-vw)),48px)] pl-[calc(clamp(16px,calc(4*var(--sf-vw)),48px)-2em)] py-[clamp(16px,calc(3*var(--sf-vh)),60px)] flex flex-col justify-center relative overflow-hidden">
        ...
        <div
          className="absolute -top-20 -right-20 w-[min(400px,calc(50*var(--sf-vw)))] h-[min(400px,calc(50*var(--sf-vw)))] opacity-[0.15]"
          style={{
        ...
        {/* Magenta accent line */}
        <div
          className="absolute bottom-[clamp(8px,calc(2*var(--sf-vh)),40px)] left-[clamp(16px,calc(4*var(--sf-vw)),48px)] w-[min(200px,calc(30*var(--sf-vw)))] h-[3px] bg-primary z-[var(--z-content)]"
          aria-hidden="true"
        />
        ...
        <div className="relative z-[var(--z-content)]">
          ...
          >
            ...
            <span className="block text-white text-[clamp(48px,calc(13.8*var(--sf-vw)),374px)] -mt-[0.05em] ml-[0.10em] relative z-10 leading-[0.92]">
      ...
      {/* Right — White panel */}
      <div className="bg-background px-[clamp(16px,calc(4*var(--sf-vw)),48px)] py-[clamp(16px,calc(3*var(--sf-vh)),60px)] flex flex-col justify-center relative" style={{ paddingBottom: "calc(clamp(16px,calc(3*var(--sf-vh)),60px) + 4.5em)" }}>
        {/* Manifesto */}
        <p className="text-[clamp(16px,calc(2.8*var(--sf-vw)),36.4px)] leading-[1.4] font-bold text-foreground max-w-[clamp(320px,calc(36.111*var(--sf-vw)),520px)]">
        ...
        <p className="mt-[var(--sfx-space-4)] text-[clamp(9px,calc(0.8*var(--sf-vw)),12px)] uppercase tracking-[0.2em] text-muted-foreground font-bold">
          48 SF COMPONENTS
        </p>

        {/* CTAs with border-draw animation */}
        <div className="flex gap-[clamp(8px,calc(1.5*var(--sf-vw)),16px)] mt-[clamp(16px,calc(3*var(--sf-vh)),40px)]">
          <Link
            href="/init"
            data-anim="cta-btn"
            className="hero-cta-btn primary relative inline-block no-underline bg-foreground text-background px-[clamp(16px,calc(2*var(--sf-vw)),28px)] py-[clamp(8px,calc(1.2*var(--sf-vh)),14px)] text-[clamp(9px,calc(0.8*var(--sf-vw)),12px)] font-bold uppercase tracking-[0.15em] border-2 border-foreground overflow-hidden"
          >
            GET STARTED
          ...
          <a
            ...
            data-anim="cta-btn"
            className="hero-cta-btn secondary relative inline-block no-underline bg-transparent text-foreground px-[clamp(16px,calc(2*var(--sf-vw)),28px)] py-[clamp(8px,calc(1.2*var(--sf-vh)),14px)] text-[clamp(9px,calc(0.8*var(--sf-vw)),12px)] font-bold uppercase tracking-[0.15em] border-2 border-foreground overflow-hidden"
          >
            VIEW ON GITHUB
        ...
        {/* Version tag */}
        <div className="absolute bottom-[clamp(8px,calc(1.5*var(--sf-vh)),24px)] right-[clamp(8px,calc(1.5*var(--sf-vw)),24px)] text-[clamp(7px,calc(0.7*var(--sf-vw)),10px)] uppercase tracking-[0.2em] text-muted-foreground">
          SF//UX v1.7 · 2026
        </div>
      </div>
