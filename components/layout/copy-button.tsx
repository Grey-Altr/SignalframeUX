  ...
  return (
    <>
      ...
      <button
        ...
        className="sf-copy sf-pressable px-[var(--sfx-space-3)] py-[var(--sfx-space-1)] text-[var(--text-2xs)] font-bold uppercase tracking-[0.2em] cursor-pointer border-none hover:brightness-110 transition-all duration-[var(--sfx-duration-normal)] bg-primary text-[oklch(0.145_0_0)]"
      >
