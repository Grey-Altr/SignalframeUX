  ...
  return (
    <>
      ...
      <button
        ...
        className="sf-copy sf-pressable absolute -top-2.5 right-3 bg-primary text-primary-foreground px-2 py-0.5 text-[var(--text-2xs)] font-bold uppercase tracking-[0.2em] cursor-pointer border-none hover:brightness-110 transition-all duration-150"
      >
