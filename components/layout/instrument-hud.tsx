  ...
  return (
    <aside
      ...
      style={{
        ...
        // Asymmetric-faceted notch — 8px cut on TL/BR, deeper 24px facet on
        // TR (panel's outermost corner, sits in the viewport TR), and a
        // steep 40×80 BL slash (~63° from horizontal) as the directional
        // cue pointing inward toward the opposite viewport corner
        // (mirroring the BR CdCornerPanel's TL cut). The TR facet is now
        // a second visible anchor; BL slash retains the dominant directional
        // role. Same cube-fill surface ties both panels into the trademark
        // family.
        clipPath:
          "polygon(8px 0, calc(100% - 24px) 0, 100% 24px, 100% calc(100% - 8px), calc(100% - 8px) 100%, 40px 100%, 0 calc(100% - 80px), 0 8px)",
      }}
    >
