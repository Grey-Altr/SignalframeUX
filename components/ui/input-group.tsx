  ...
  "flex h-auto cursor-text items-center justify-center gap-[var(--sfx-space-2)] py-[var(--sfx-space-1)].5 text-sm font-medium text-muted-foreground select-none group-data-[disabled=true]/input-group:opacity-50 [&>kbd]:rounded-[calc(var(--radius)-5px)] [&>svg:not([class*='size-'])]:size-4",
  {
    variants: {
      align: {
        ...
        "block-start":
          "order-first w-full justify-start px-[var(--sfx-space-2)].5 pt-[var(--sfx-space-2)] group-has-[>input]/input-group:pt-[var(--sfx-space-2)] [.border-b]:pb-[var(--sfx-space-2)]",
        "block-end":
          "order-last w-full justify-start px-[var(--sfx-space-2)].5 pb-[var(--sfx-space-2)] group-has-[>input]/input-group:pb-[var(--sfx-space-2)] [.border-t]:pt-[var(--sfx-space-2)]",
      },
    },
    defaultVariants: {
      align: "inline-start",
