...
function SFCardHeader({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(CardHeader, { className: cn("pb-[var(--sfx-space-3)]", className), ...props });
}
...
function SFCardContent({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(CardContent, { className: cn("p-[var(--sfx-space-4)]", className), ...props });
}
function SFCardFooter({
  className,
  ...props
}) {
  return /* @__PURE__ */ jsxRuntime.jsx(CardFooter, { className: cn("p-[var(--sfx-space-4)] pt-0", className), ...props });
}
...
function SFTableCell({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(TableCell, { className: cn("px-[var(--sfx-space-3)] py-[var(--sfx-space-2)]", className), ...props });
}
...
function CommandInput({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { "data-slot": "command-input-wrapper", className: "p-[var(--sfx-space-1)] pb-0", children: /* @__PURE__ */ jsxRuntime.jsxs(InputGroup, { className: "h-8! rounded-lg! border-input/30 bg-input/30 shadow-none! *:data-[slot=input-group-addon]:pl-2!", children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      cmdk.Command.Input,
      {
...
function SFRadioGroup({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(RadioGroup, { className: cn("grid gap-[var(--sfx-space-2)]", className), ...props });
}
...
function SFNavigationMenuMobile({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: cn("md:hidden", className), children: /* @__PURE__ */ jsxRuntime.jsxs(SFSheet, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(SFSheetContent, { side: "left", children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx("nav", { className: "flex flex-col gap-[var(--sfx-space-1)] mt-[var(--sfx-space-4)]", children })
    ] })
  ] }) });
}
...
function createSignalframeUX(config = {}) {
  function SignalframeProvider({ children }) {
    const [isDark, setIsDark] = React7.useState(() => {
