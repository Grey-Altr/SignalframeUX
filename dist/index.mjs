...
import React7__default, { createContext, useContext, useState, useId, useRef, useEffect, useCallback, useMemo } from 'react';
import { jsx, jsxs } from 'react/jsx-runtime';
import { Select as Select$1, ToggleGroup, Slot, Tabs as Tabs$1, Separator as Separator$1, Tooltip as Tooltip$1, Dialog as Dialog$1, DropdownMenu as DropdownMenu$1, Toggle as Toggle$1, Slider as Slider$1, Popover as Popover$1, ScrollArea as ScrollArea$1, Label as Label$1, Checkbox as Checkbox$1, RadioGroup as RadioGroup$1, Switch as Switch$1, AlertDialog as AlertDialog$1, Collapsible as Collapsible$1, Avatar as Avatar$1, NavigationMenu as NavigationMenu$1, HoverCard as HoverCard$1 } from 'radix-ui';
import { Loader2, User, Menu, XIcon, SearchIcon, CheckIcon, ChevronDown, Check, ChevronRightIcon, ChevronLeftIcon, ChevronDownIcon, MinusIcon, ChevronUp } from 'lucide-react';
...
var SFContainer = React7__default.forwardRef(
...
var SFSection = React7__default.forwardRef(
...
var SFStack = React7__default.forwardRef(
...
var SFGrid = React7__default.forwardRef(
...
var SFText = React7__default.forwardRef(
...
function SFCard({ className, hoverable = false, borderDraw = false, ...props }) {
  ...
  if (borderDraw) {
    return /* @__PURE__ */ jsx(BorderDraw, { children: card });
  }
  return card;
}
...
function SFTooltipTrigger(props) {
  return /* @__PURE__ */ jsx(TooltipTrigger, { ...props });
}
function Dialog({
  ...props
}) {
...
function SFDialogClose(props) {
  return /* @__PURE__ */ jsx(DialogClose, { ...props });
}
...
function SFDropdownMenuTrigger(props) {
  return /* @__PURE__ */ jsx(DropdownMenuTrigger, { ...props });
}
...
function SFCommandDialog({
  ...
  return /* @__PURE__ */ jsx(CommandDialog, { className: cn("rounded-none", className), ...props });
}
...
function SelectTrigger({
  ...
  return /* @__PURE__ */ jsxs(
    Select$1.Trigger,
    {
      ...
      children: [
        children,
        /* @__PURE__ */ jsx(Select$1.Icon, { asChild: true, children: /* @__PURE__ */ jsx(ChevronDown, { className: "h-4 w-4 opacity-50" }) })
      ]
    }
  );
}
...
function SelectItem({
  ...
  return /* @__PURE__ */ jsxs(
    Select$1.Item,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx("span", { className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center", children: /* @__PURE__ */ jsx(Select$1.ItemIndicator, { children: /* @__PURE__ */ jsx(Check, { className: "h-4 w-4" }) }) }),
...
function SFSelectGroup(props) {
  return /* @__PURE__ */ jsx(SelectGroup, { ...props });
}
...
function RadioGroupItem({
  ...
  return /* @__PURE__ */ jsx(
    RadioGroup$1.Item,
    {
      ...
      ...props,
      children: /* @__PURE__ */ jsx(RadioGroup$1.Indicator, { className: "flex items-center justify-center", children: /* @__PURE__ */ jsx("div", { className: "h-2 w-2 bg-current" }) })
    }
  );
}
...
function SFAlertDescription(props) {
  return /* @__PURE__ */ jsx(AlertDescription, { ...props });
}
...
function SFAlertDialog(props) {
  return /* @__PURE__ */ jsx(AlertDialog, { ...props });
}
function SFAlertDialogTrigger(props) {
  return /* @__PURE__ */ jsx(AlertDialogTrigger, { ...props });
}
...
function SFAlertDialogHeader({
  ...
  return /* @__PURE__ */ jsx(AlertDialogHeader, { className: cn(className), ...props });
}
function SFAlertDialogFooter({
  className,
  ...props
}) {
  return /* @__PURE__ */ jsx(AlertDialogFooter, { className: cn("rounded-none", className), ...props });
}
...
function SFAlertDialogDescription(props) {
  return /* @__PURE__ */ jsx(AlertDialogDescription, { ...props });
}
function SFAlertDialogAction({
  ...
  return /* @__PURE__ */ jsxs(
    AlertDialogAction,
    {
      ...
      ...props,
      children: [
        loading && /* @__PURE__ */ jsx(Loader2, { className: "mr-2 size-4 animate-spin" }),
        children
      ]
    }
  );
...
function SFAlertDialogCancel({
  ...
  return /* @__PURE__ */ jsx(AlertDialogCancel, { className: cn("rounded-none", className), ...props });
}
...
function SFCollapsible(props) {
  return /* @__PURE__ */ jsx(Collapsible, { ...props });
}
function SFCollapsibleTrigger(props) {
  return /* @__PURE__ */ jsx(CollapsibleTrigger, { ...props });
}
function SFCollapsibleContent(props) {
  return /* @__PURE__ */ jsx(CollapsibleContent, { ...props });
}
function Avatar({
  className,
  size = "default",
...
function SFAvatarImage({
  ...
  return /* @__PURE__ */ jsx(AvatarImage, { className: cn("rounded-none", className), ...props });
}
function SFAvatarFallback({
  ...
  return /* @__PURE__ */ jsx(AvatarFallback, { className: cn("rounded-none", className), ...props, children: children ?? /* @__PURE__ */ jsx(User, { className: "size-[60%] text-foreground" }) });
}
...
function SFBreadcrumb(props) {
  return /* @__PURE__ */ jsx(Breadcrumb, { ...props });
}
function SFBreadcrumbList({
  className,
  ...props
}) {
  return /* @__PURE__ */ jsx(BreadcrumbList, { className: cn("font-mono", className), ...props });
}
function SFBreadcrumbItem(props) {
  return /* @__PURE__ */ jsx(BreadcrumbItem, { ...props });
}
function SFBreadcrumbLink(props) {
  return /* @__PURE__ */ jsx(BreadcrumbLink, { ...props });
}
function SFBreadcrumbPage(props) {
  return /* @__PURE__ */ jsx(BreadcrumbPage, { ...props });
}
function SFBreadcrumbSeparator({
  className,
  ...props
}) {
  return /* @__PURE__ */ jsx(BreadcrumbSeparator, { className: cn("font-mono", className), ...props, children: "/" });
}
...
function SFPagination({
  ...
  return /* @__PURE__ */ jsx(Pagination, { className: cn("font-mono", className), ...props });
}
function SFPaginationContent({
  className,
  ...props
}) {
  return /* @__PURE__ */ jsx(PaginationContent, { className: cn("gap-0", className), ...props });
}
function SFPaginationItem(props) {
  return /* @__PURE__ */ jsx(PaginationItem, { ...props });
}
...
function SFNavigationMenuList({
  ...
  return /* @__PURE__ */ jsx(NavigationMenuList, { className: cn(className), ...props });
}
function SFNavigationMenuItem({
  className,
  ...props
}) {
  return /* @__PURE__ */ jsx(NavigationMenuItem, { className: cn(className), ...props });
}
...
function SFNavigationMenuMobile({
  ...
  return /* @__PURE__ */ jsx("div", { className: cn("md:hidden", className), children: /* @__PURE__ */ jsxs(SFSheet, { children: [
    /* @__PURE__ */ jsx(
      SFSheetTrigger,
      {
...
var SFToggleGroupContext = React7.createContext({});
function SFToggleGroup({
  ...
  return /* @__PURE__ */ jsx(
    ToggleGroup.Root,
    {
      ...
      ...props,
      children: /* @__PURE__ */ jsx(SFToggleGroupContext.Provider, { value: { intent, size }, children })
    }
  );
}
function SFToggleGroupItem({
  ...
  const context = React7.useContext(SFToggleGroupContext);
  return /* @__PURE__ */ jsx(
    ToggleGroup.Item,
    {
...
function SFInputGroupText({
  ...
  return /* @__PURE__ */ jsx(InputGroupText, { className: cn("rounded-none", className), ...props });
}
...
function SFInputOTP({
  ...
  return /* @__PURE__ */ jsx(InputOTP, { className: cn("font-mono", className), ...props });
}
function SFInputOTPGroup({
  className,
  ...props
}) {
  return /* @__PURE__ */ jsx(InputOTPGroup, { className: cn("rounded-none", className), ...props });
}
...
function SFInputOTPSeparator(props) {
  return /* @__PURE__ */ jsx(InputOTPSeparator, { ...props });
}
function HoverCard({
  ...props
}) {
...
function SFHoverCard(props) {
  return /* @__PURE__ */ jsx(HoverCard, { ...props });
}
function SFHoverCardTrigger(props) {
  return /* @__PURE__ */ jsx(HoverCardTrigger, { ...props });
}
...
function createSignalframeUX(config = {}) {
  function SignalframeProvider({ children }) {
    ...
    return /* @__PURE__ */ jsx(SignalframeContext.Provider, { value: { theme: isDark ? "dark" : "light", setTheme, motion }, children });
  }
