...
function initSignalCanvas(canvas) {
  ...
  if (!state.reducedMotion) {
    gsap__default.default.ticker.add(tickerCallback);
  } else {
    renderAllScenes(state);
  }
  const motionHandler = (e) => {
    ...
    if (e.matches) {
      gsap__default.default.ticker.remove(tickerCallback);
      renderAllScenes(state);
    } else {
      gsap__default.default.ticker.add(tickerCallback);
    }
...
exports.SignalCanvas = SignalCanvas;
exports.resolveColorToken = resolveColorToken;
exports.useSignalScene = useSignalScene;
